...
#define DEFAULT_SYSCONFDIR "/usr/etc"
...
#define PACKAGE_STRING "MySQL Server 5.5.57"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.5.57"
...
#define DEFAULT_SECURE_FILE_PRIV_DIR "/var/lib/mysql-files"
